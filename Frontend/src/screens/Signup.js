...
export default function Signup() {
    const [information, setinformation] = useState({name:'',email:'',password:'',geolocation:''})
    ...
    const handleSubmit=async(e)=>{
        ...
        body:JSON.stringify({name:information.name, email:information.email, password:information.password, location:information.geolocation})
    })
    ...
    return (
        ...
        <div className='container'>
            ...
            <div className="mb-3">
                    ...
                    <input type="text" className="form-control" name='name' value={information.name} onChange={onChange}/>
                </div>
                <div className="mb-3">
...
{/*onChange allows us to make changes in the name, email, pw sections, else
    they shall always remain static, meaning, they wont allow any change in them*/}
                ...
                <div className="mb-3">
                    ...
                    <input type="geolocation" className="form-control" name='geolocation' value={information.geolocation} onChange={onChange} id="exampleInput1" aria-describedby="passwHelp" />
                </div>
